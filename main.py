...
def scraper():
    ...
    try:
        ...
        for match in matches:
            ...
            if "WINDOWS ACESTREAM" not in canal and "ANDROID ACESTREAM.APK" not in canal and "AQUÍ" not in canal and "EUR / RU / NA / SA - TV" not in canal and "720p" in canal:
                canal = canal.replace("1080p", "720p")
